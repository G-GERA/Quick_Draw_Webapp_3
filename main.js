...
answer_holder = "";
score = 0;
var random_num = Math.floor((Math.random()*quick_draw_data_set.length)+1);

console.log(Element_of_array = quick_draw_data_set[random_num]);

random_num = quick_draw_data_set[random_num];

document.getElementById('sketch_to_be_drawn').innerHTML = 'Sketch to be drawn: ' + random_num;
